  ...
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-content">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group"><label for="formatosPlacaMaeSuportados">Formatos de Placa-mãe Suportados</label><input id="formatosPlacaMaeSuportados" v-model="formData.formatosPlacaMaeSuportados" type="text" required placeholder="Ex: ATX, Micro-ATX, Mini-ITX" /></div>
...
const props = defineProps({ gabinete: { type: Object, default: null } });
// formData ATUALIZADO
const formData = ref({ id: null, nome: '', marca: '', formatosPlacaMaeSuportados: '', preco: 0.0 });
const modalTitle = computed(() => props.gabinete ? 'Editar Gabinete' : 'Adicionar Novo Gabinete');
watch(() => props.gabinete, (newVal) => {
  formData.value = newVal ? { ...newVal } : { id: null, nome: '', marca: '', formatosPlacaMaeSuportados: '', preco: 0.0 };
}, { immediate: true });
